...
import {
  arrLenguajeDeMarca,
  arrLenguajeDeProgramacion,
  arrFrameWorks,
} from "../../public/assets/import.js";
...
const Portfolio = () => {
  return (
    <>
      <Hero
        titulo={infoPersonalData.nombre}
        subtitulo={infoPersonalData.subtitulo}
        images={[html, css, js, angular]}
        descripcion={infoPersonalData.descripcion}
        tecnologiasInfo={redesSociales}
        bool={true}
      ></Hero>
